var APP_com_test = (function () {
	...
	class MainSliderItem extends Lightning.Component{
	    static _template(){
	        return {
	...
	class Details extends Lightning.Component{
	    ...
	    set asset(v){
	        ...
	        this._blur.tag("Background").src = Utils.asset(`${v.path}/backdrop.jpg`);
	...
	class App extends Lightning.Component {
	    ...
	    static getFonts() {
	        return [
	            {family: 'RobotoBold', url: Utils.asset('fonts/Roboto-Bold.ttf'), descriptors: {}},
	            {family: 'RobotoRegular', url: Utils.asset('fonts/Roboto-Regular.ttf'), descriptors: {}}
	        ];
	    }
